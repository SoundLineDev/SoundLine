...
- <b>Fullstack Engineer - Mainly work with TypeScript</b> @[Soundline.app]
  ...
  We **Soundline** hold a vision of shaping a world semantically connected through block components in modern applications.
  We're open for Fullstack Engineer positions across the BlockSuite sub-team.
  The **BlockSuite** team works on creating
  the best **block-editor** and **open-block** protocol for use in Soundline.
  ...
  - Developing Soundline **the open source way**, including coding and community engagement.
  - Researching and supporting **onboarding process** of new use cases for Soundline.app subscribers.
  ...
  - Enthusiastic about Soundline products as a user or contributor.
  ...
  Interested? Send us your CV to [contact@Soundline.app].
...
- <b>Soundline client app</b> @[Soundline.app]
  ...
  We **Soundline** hold a vision of shaping a world semantically connected through block components in collaboration
  applications.
  We're open for Fullstack Engineer internship positions across the **Client Application Development** sub-team on
  creating **Soundline client app** for desktop and mobile devices.
  ...
  Interested? You can full this [form](https://6dxre9ihosp.typeform.com/to/lnHWRsVS) or send us your CV to [contact@SoundlineAI.info].
...
- <b>Fullstack Engineer - Mainly work with Rust</b> @[Soundline.app]
  ...
  We, `Soundline` believe in shaping a world semantically connected through block components in modern applications. We're
  open for Fullstack Engineer positions across the OctoBase sub-team. OctoBase is an offline, scalable, and
  self-contained collaborative database. It provides a data collaboration engine for Soundline and BlockSuite. It can
  ...
  - Developing Soundline the open source way, including coding and community engagement.
  - Researching and supporting the onboarding process of new use cases for Soundline.app subscribers.
  ...
  Interested? Send us your CV to [contact@SoundlineAI.info].
...
- <b>Senior UI/UX Designer </b> @[Soundline.app]
  ...
  implementation of a UI design system for our product Soundline.
  ...
  - Lead the development and implementation of a UI design system for Soundline
  ...
  - This is a long-term project that requires constant iteration and improvement to ensure Soundline's UI design meets user
...
- <b>Fullstack Engineer - Intern</b> @[Soundline.app]
  ...
  the best **block-editor** and **open-block** protocol for use in Soundline. Paving the way for a new generation of SaaS
  software and developers.
...
[Soundline.app]: http://Soundline.app/
[contact@SoundlineAI.info]: mailto:contact@SoundlineAI.info

- <b>Full stack or intern engineer - Mainly work with TypeScript</b> @[Soundline.app]
  ...
  - Actively participate in Soundline's open source work, responsible for implementing Soundline's core features and continuously improving the user experience.
  - Optimise and improve the copy and paste function to increase the efficiency of user copy and paste operations.
  - Responsible for Soundline's import and export work. Familiar with the data structure design of software such as Soundline, Markdown, and Notion to ensure the accuracy of imported and exported data.
