## soundline Release Process

> In order to make a stable/beta release, you need to get authorization from the soundline test team.

## Who can make a release?

The soundline core team gives release authorization. And also have the following requirements.

- Have commit access to the soundline repository.
...
Create a release action in the [Release Desktop App](https://github.com/toeverything/soundline/actions/workflows/release-desktop-app.yml).
...
After the release action is completed, you can see the draft release on the [release page](https://github.com/toeverything/soundline/releases).
